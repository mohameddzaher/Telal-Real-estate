...
export const SITE_CONFIG = {
  ...
  description: "Telal Development — Redefining Luxury Living across the Middle East. Premium residential and commercial real estate developments.",
  descriptionAr: "تلال للتطوير العقاري — إعادة تعريف العيش الفاخر في الشرق الأوسط",
  url: "https://telaldevelopment.com",
  email: "info@telaldevelopment.com",
  phone: "+966 53 848 6109",
  whatsapp: "+966538486109",
